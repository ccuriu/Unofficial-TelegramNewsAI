# TelegramNewsAI 5.4.6 Stable

TelegramNewsAI — локальная Windows-программа для сбора публикаций из выбранных Telegram-каналов, хранения истории в SQLite, быстрого тематического поиска и подготовки структурированных JSON-выгрузок для анализа в ИИ-ассистентах.
