...
>
> Публичный релиз больше не является обязательной целью и будет рассматриваться отдельно только если это действительно будет полезно. Поэтому основная ветка оптимизируется прежде всего под качество личного дайджеста, надёжность Telegram-сессии и минимальную лишнюю нагрузку на API.
>
> Telegram предупреждает, что неофициальные API-клиенты находятся под дополнительным наблюдением, а точные антиспам-лимиты не публикуются. Практически используемый диапазон каналов не следует считать гарантированно безопасным пределом.
>
> Вопросы Content Licensing/AI и Sponsored Messages относятся прежде всего к решению о возможном будущем публичном распространении. Они не являются поводом ухудшать полезную личную версию без практической необходимости.
