...
- ограниченный `continuity_context` для продолжающихся сюжетов: несколько недавних сообщений вне текущего периода могут быть приложены как предыстория, но не считаются сегодняшними новостями и не расширяют статистику выпуска;
