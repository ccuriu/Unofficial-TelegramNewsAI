...
- Встроенная редакционная инструкция в JSON ничего не отправляет наружу сама по себе; перед public-релизом её использование и документация ещё раз сверяются с актуальными условиями Telegram.
- Требования Content Licensing и Sponsored Messages проверяются отдельно как часть финального public-review.

Открытие репозитория планируется после прохождения согласованной матрицы нагрузок, проверки стабильности/целостности данных и закрытия этих публичных требований.
