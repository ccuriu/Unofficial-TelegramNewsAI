...
![Status](https://img.shields.io/badge/status-5.4.11%20Testing-orange)
...
В тестовой ветке 5.4.11 добавлен более консервативный профиль обращения к API: явная пауза между последовательными запросами истории, пауза между каналами с увеличением для больших списков и защитная остановка всего текущего сетевого этапа при необработанном длинном `FloodWait`. Эти меры уменьшают пики запросов, но не считаются доказательством «безопасного лимита».
