...
box(c, right, y, ww, hh, "Шаг 2 - API Hash", "Щёлкните правой кнопкой мыши в окне, затем нажмите <b>Enter</b>. Нужно вставить все 32 символа. Ввод скрытый - символы могут не отображаться.")
y -= 46*mm
...
banner(c, 18*mm, H-166*mm, W-36*mm, 20*mm, "Для API Hash щёлкните правой кнопкой мыши в окне. Если вставка не сработала, запасной вариант - Shift+Insert. Если программа пишет, что длина Hash неправильная, убедитесь, что вставлены все 32 символа без пробелов.", "orange")
