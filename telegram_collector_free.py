...
EDITORIAL_PRINCIPLES = (
    ...
    "пиши «Первоначально сообщалось…, позже выяснилось…». Перед итогом проверь более поздние сообщения на опровержение, блокировку, "
    "уточнение, отмену или смену статуса. Не повышай уверенность относительно источника: «возможно», «по данным источника» и "
