...
SOURCE_RULES = (
    ...
    "используй ровно эту строку и копируй ДОСЛОВНО, иначе используй channel_url. Источник оформляй кликабельной Markdown-ссылкой: "
    "**Источник:** [Канал](https://t.me/...) . Адрес внутри круглых скобок должен дословно совпадать с исходным SOURCE_URL/telegram_url/channel_url. "
    "URL не придумывай: не заменяй t.me Google, search или redirect-ссылкой, не добавляй utm_source, не сокращай, не нормализуй, "
    "не меняй query и не «исправляй» по памяти. При сомнении используй исходную literal URL как цель Markdown-ссылки. Для простого "
