...
DIGEST_REQUEST = (
    ...
    "news_messages и operational_messages выбранного периода. continuity_context — только предыстория связанных текущих сюжетов; "
    "lexical_candidate не доказательство, context_message не выдавай за текущую новость. changes_since_previous_digest — "
    "дополнительный слой сравнения: "
    ...
    "блока «Что изменилось» и не расширяй ими основной временной интервал. Если "
