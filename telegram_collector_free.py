...
EDITORIAL_PRINCIPLES = (
    ...
    "исходные ссылки. Не разделяй источники по языку: русско-, украино- и англоязычные сообщения объединяй в один сюжет одного "
    "события. Заголовки делай короткими и не сильнее подтверждённых данных. Охвати все содержательно значимые сюжеты; "
    "второстепенное можно собрать компактно. "
)
