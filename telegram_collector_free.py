...
SOURCE_RULES = (
    ...
    "используй ровно эту строку и копируй ДОСЛОВНО, иначе используй channel_url. Источник оформляй Markdown-ссылкой: "
    "**Источник:** [Канал](https://t.me/...). URL в скобках копируй ДОСЛОВНО из исходного поля; не подменяй его Google/search/redirect, "
    "не добавляй utm_source, не сокращай, не нормализуй, не меняй query и не «исправляй» по памяти. При сомнении используй исходный "
    "literal URL. Для простого "
