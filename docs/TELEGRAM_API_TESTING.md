...
Поддерживаемый продуктовый максимум 50 источников уже принят. 51-й источник отклоняется локально до дополнительной сетевой работы. Испытания 60/75/100 источников не являются условием Stable.
